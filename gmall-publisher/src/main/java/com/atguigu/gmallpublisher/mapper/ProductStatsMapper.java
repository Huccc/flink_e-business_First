...
public interface ProductStatsMapper {
    ...
    @Select("select tm_id,tm_name,sum(order_amount) order_amount from product_stats_210726 " +
     ...
     * 获取某一天不同品类的交易额
     */
    @Select("select category3_id,category3_name,sum(order_amount) order_amount from product_stats_210726 " +
     ...
     * 获取某一天不同SPU的交易额
     */
    @Select("select spu_id,spu_name,sum(order_amount) order_amount,sum(order_ct) order_ct from product_stats_210726 " +
